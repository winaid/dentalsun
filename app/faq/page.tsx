    ...
    <>
      ...
      <main id="main">
        <HeroCollage
          ...
          lead="진료시간과 예약, 오시는 길, 비용과 보험, 마취와 수면치료까지 자주 받는 질문을 모았습니다. 여기에 없는 궁금증은 전화로 편하게 물어보세요."
          bg="ai/wide-visit"
          cards={[
          ...
          items={[
            { title: '진료시간 · 예약', desc: '월~금 10:00~19:00, 화·목요일은 밤 9시까지 야간진료, 토요일은 2·4째주 10:00~14:00' },
        ...
        <ContactBand title="여기에 없는 질문은 전화로 물어보세요" />
        <MedicalNotice />
      </main>
    </>
  );
