...
const DESC = '광화문 선치과 디지털 장비 — 3D 구강스캐너, 저선량 3D CT, 컴퓨터 모의수술 분석, 수술 가이드, 당일 디지털 보철(캐드캠·3D 프린터), INOS 실시간 소독, 무통마취기, 에어플로우, PHL-15 레이저.';
...
const ITEMS: Array<{ n: string; title: string; desc: string; more?: string[]; fig: Fig }> = [
  { n: 'Point 01', title: '디지털 진단장비, 3D 구강스캐너', desc: '기존의 본뜨는 작업을 3D 구강스캐너가 대체하여 불편했던 치과 치료를 편하게.', fig: { key: 'equip/scanner', alt: '3D 구강스캐너로 스캔한 치아 데이터가 모니터에 표시된 진료 장면' } },
  { n: 'Point 02', title: '디지털 진단장비, 저선량 3D CT', desc: '3D 촬영으로 보다 정확하고 안전한 진단.', more: ['여러가지 영상을 제공하는 올인원 시스템', '파노라마와 CT를 함께 촬영 가능', '짧은 촬영시간과 적은 방사선 노출량으로 안전한 CT'], fig: { key: 'place/place08', alt: '광화문선치과 3D CT 촬영실' } },
  { n: 'Point 03', title: '오차를 줄인 디지털 분석 시스템', desc: '임플란트 수술 시 컴퓨터가 모의수술을 통해 미리 결과를 예측할 수 있어 오차를 최소화할 수 있습니다.', fig: { key: 'equip/planning', alt: '임플란트 식립 경로 분석 화면' } },
  ...
  { n: 'Point 06', title: '교차감염 방지, 디지털 실시간 소독 시스템', desc: '진료기구를 통해 발생하는 교차감염의 위험성을 최소화하기 위해 INOS 소독기를 사용하여 실시간으로 소독합니다.', more: ['KTR(한국화학융합시험연구원) 소독력 테스트 완료'], fig: { key: 'scene/sterile', alt: '멸균 소독한 진료 기구' } },
  ...
  { n: '턱관절', title: '턱관절 물리치료 장비, PHL-15 레이저', desc: '저출력 레이저 및 저주파 전기치료기를 이용하여 턱관절 근육 통증 완화. 원적외선보다 5배 높은 피부 침투력, 증상에 따른 여러 가지 치료 모드, 건강보험 적용.', fig: { key: 'equip/laser', alt: '턱관절 물리치료 장비 PHL-15 레이저' } },
  { n: '신경치료', title: '엔도소닉 초음파 세척기', desc: '신경치료 시 남아 있는 신경과 염증을 미세 초음파로 깨끗하게 제거·소독하여 성공률을 높여 줍니다.', fig: { key: 'scene/endosonic', alt: '엔도소닉 초음파 세척기' } },
];
      ...
      <main id="main" className="pt-[72px] md:pt-[84px]">
        <section className="section bg-canvas">
          <div className="wrap">
            ...
            <p className="eyebrow mt-6">DIGITAL EQUIPMENT</p>
