...
const ITEMS: Array<{ n: string; title: string; desc: string; more?: string[]; fig: Fig; ratio?: string }> = [
  ...
  { n: 'Point 06', title: '교차감염 방지, 디지털 실시간 소독 시스템', desc: '진료기구를 통해 발생하는 교차감염의 위험성을 최소화하기 위해 INOS 소독기를 사용하여 실시간으로 소독합니다.', more: ['KTR(한국화학융합시험연구원) 소독력 테스트 완료'], fig: { key: 'ai/sterile', alt: '밀봉 소독된 진료 기구와 소독기' } },
  ...
  { n: '턱관절', title: '턱관절 물리치료 장비, PHL-15 레이저', desc: '저출력 레이저 및 저주파 전기치료기를 이용하여 턱관절 근육 통증 완화. 원적외선보다 5배 높은 피부 침투력, 증상에 따른 여러 가지 치료 모드, 건강보험 적용.', fig: { key: 'ai/tmj-treatments', alt: '턱관절 물리치료 레이저 핸드피스와 스플린트' } },
  { n: '신경치료', title: '엔도소닉 초음파 세척기', desc: '신경치료 시 남아 있는 신경과 염증을 미세 초음파로 깨끗하게 제거·소독하여 성공률을 높여 줍니다.', fig: { key: 'ai/natural-endosonic', alt: '초음파 근관 세척 핸드피스' } },
];
...
export default function EquipmentPage() {
  ...
  return (
    <>
      ...
      <main id="main">
        <PageHero trail={trail} eyebrow="DIGITAL EQUIPMENT" bg="ai/hero-wide-2" title={<>첨단 디지털 장비로 진료하는
              <br />
