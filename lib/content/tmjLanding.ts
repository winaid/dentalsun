...
/** 치료 원칙 — 옛 치료방법 문서 '보존적 치료를 먼저' 요약 */
export const TMJ_PRINCIPLE = {
  title: '되돌릴 수 있는 치료부터',
  text: '턱에 무리를 주는 습관을 고치는 행동 조절, 약물치료, 물리치료가 첫 단계이고 여기에 스플린트 장치치료를 더해 관절과 근육을 안정시킵니다. 근육의 과활성이 뚜렷하면 보톡스를, 염증이 심해 입이 벌어지지 않으면 관절강 세척술을 고려하며, 수술은 보존적 치료로 효과가 없고 구조적인 문제가 확인될 때에만 검토합니다.',
};
