...
/**
 * 거울 앞 자가진단 5단계 — 2026-09-17 오너가 참고하라고 준 턱관절 자가진단 안내를 바탕으로 보탬.
 * 확인하는 '방법'과 '정상 범위'(개구량 40~60mm, 앞·옆 10mm)는 교과서 수준의 일반 지식이라 그대로 두고,
 * '심각한 손상' 같은 겁주는 표현은 옮기지 않았다. 판정은 늘 "의심해 볼 수 있다" 까지.
 */
/** 사진은 넣지 않는다 — 바로 위 증상 4장과 같은 사진이 또 나와 '같은 사진 반복'(오너 지적)이 됐다. 번호 타일만 */
...
export const TMJ_SELF_TESTS: TmjSelfTest[] = [
  {
    n: '01',
    title: '입을 벌릴 때 중심선이 똑바른가요?',
    how: '거울을 보며 위 앞니와 아래 앞니의 가운데 선을 맞춘 상태에서 천천히 입을 벌립니다. 아래턱이 곧게 내려오는지 봅니다.',
    means: '한쪽으로 돌아가거나 지그재그로 벌어지면 관절원판(디스크)이나 턱을 움직이는 근육의 이상을 의심해 볼 수 있습니다. 다물고 있을 때 1mm쯤 치우쳐 있다가 벌리면서 5mm 넘게 한쪽으로 가기도 합니다.',
  },
  {
    n: '02',
    title: '턱관절에서 소리가 나나요?',
    how: '양손 손가락을 귀 바로 앞 턱관절 부위에 가볍게 대고 입을 벌렸다 다물어 봅니다.',
    means: '“딱” 하는 소리나 걸리는 느낌이 있으면 관절원판이 제자리를 벗어났다 돌아오는 것일 수 있습니다.',
  },
  {
    n: '03',
    title: '크게 벌릴 때 불룩 튀어나오나요?',
    how: '같은 자세로 입을 최대한 크게 벌리는 순간, 귀 앞이 불룩하게 올라왔다가 다물 때 다시 들어가는지 만져 봅니다.',
    means: '올라왔다 들어간다면 턱뼈 끝(하악과두)이 관절 밖으로 자주 빠져나오는 습관성 탈구를 의심해 볼 수 있습니다.',
  },
  {
    n: '04',
    title: '입이 충분히 벌어지나요?',
    how: '검지·중지·약지 세 손가락을 세로로 모아 입에 넣어 봅니다. 편하게 들어가면 정상 범위입니다.',
    means: '세 손가락이 들어가지 않을 만큼(대략 40mm 미만) 벌어지지 않으면 턱관절 장애를 의심해 볼 수 있고, 두 손가락도 어렵다면(대략 20mm 이하) 미루지 말고 진료를 받아 보세요.',
    normal: '정상 40~60mm',
  },
  {
    n: '05',
    ...
    means: '한쪽만 잘 안 가거나 움직일 때 아프면 그쪽 관절이나 근육에 부담이 있는 것일 수 있습니다.',
    normal: '정상 약 10mm',
  },
];
