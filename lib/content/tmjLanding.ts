...
export const TMJ_KNOWHOW = {
  ...
  items: [
    { title: '정확한 진단', desc: '재발하지 않기 위한 근본적인 치료를 위해서는 약간의 오차로 인해 만족스럽지 못한 결과가 나올 수 있기에, 최신 장비를 통한 정확한 진단이 이루어집니다.', fig: { key: 'scene/tmj-1', alt: '턱관절을 촬영하는 CT 장비' } },
    { title: '전반적인 턱관절 치료 진행', desc: '간단한 약물치료, 물리치료뿐만이 아니라 보톡스, 스플린트 장치치료 등의 전반적인 치료를 진행합니다. 턱관절은 장기적 치료가 필요한 경우가 많아 전반적인 치료를 할 수 있는 치과를 방문하셔야 합니다.', fig: { key: 'scene/tmj-2', alt: '장갑 낀 손으로 스플린트 장치를 다듬는 모습' } },
    { title: '오랜 기간 다수의 턱관절 환자 진료', desc: '턱관절 치료의 경우 환자분마다 각기 다른 증상을 보여 원인을 찾기가 어려운 경우가 있습니다. 오랜 기간 다수의 환자분들을 진료하며 얻은 노하우로 정확한 원인을 찾아 근본적인 치료를 하고 있습니다.', fig: { key: 'scene/tmj-3', alt: '모니터를 보며 턱관절 상태를 설명하는 모습' } },
  ] as TmjCard[],
};
